...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_home_status.setText(QCoreApplication.translate("MainWindow", u"Status: Closed", None))
        self.version.setText(QCoreApplication.translate("MainWindow", u"v.0.0.1", None))
        self.label_control_status.setText(QCoreApplication.translate("MainWindow", u"Status: Closed", None))
